...
export function VendedorDashboardCharts({ salesData, metrics, adminCommissionRate }: VendedorChartsProps) {
  ...
  // Transform salesData for recharts
  const chartSales = salesData.length > 0 ? salesData : [
          ...
          <div className="h-[180px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartSales} margin={{ top: 5, right: 5, left: -15, bottom: 0 }}>
                <defs>
                  <linearGradient id="gradVendorSales" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area type="monotone" dataKey="vendas" name="Vendas" stroke="#00f0ff" strokeWidth={2} fill="url(#gradVendorSales)"
